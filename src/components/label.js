    ...
    if (label.editing) {
      content = (
        <form onSubmit={this.onSubmitForm} className='label'>
          <span style={{backgroundColor: labelColor}} className='label-color avatar avatar-small avatar-rounded'>&nbsp;</span>
      ...
      content = (
        <div className='label'>
          <span style={{backgroundColor: labelColor}} className='label-color'>&nbsp;</span>
